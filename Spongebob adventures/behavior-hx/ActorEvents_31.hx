...
class ActorEvents_31 extends ActorScript
{
	...
	override public function init()
	{
		...
		/* ========================= Type & Type ========================== */
		addSceneCollisionListener(getActorType(31).ID, getActorType(0).ID, function(event:Collision, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				recycleActor(actor);
		...
		/* ========================= Type & Type ========================== */
		addSceneCollisionListener(getActorType(31).ID, getActorType(4).ID, function(event:Collision, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
